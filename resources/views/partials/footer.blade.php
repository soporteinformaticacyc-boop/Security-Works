        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-300">
                    <li><a href="{{ route('home') }}" class="hover:text-red-500 hover:pl-2 transition-all duration-300 flex items-center"><span class="mr-2">›</span> Inicio</a></li>
                    <li><a href="{{ route('cursos') }}" class="hover:text-red-500 hover:pl-2 transition-all duration-300 flex items-center"><span class="mr-2">›</span> Cursos</a></li>
                    <li><a href="{{ route('contacto') }}" class="hover:text-red-500 hover:pl-2 transition-all duration-300 flex items-center"><span class="mr-2">›</span> Contáctanos</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-4 text-gray-300">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <a href="tel:+56982184309" class="hover:text-white transition">+56 9 8218 4309</a>
                        </div>
                    </div>
                ...
                <div class="flex space-x-4 mt-6">
                    <a href="https://api.whatsapp.com/send?phone=56953976610" class="bg-gray-800 p-2 rounded-full hover:bg-green-600 hover:text-white transition">
                    ...
                    <a href="https://www.instagram.com/securitywork.chile/" class="bg-gray-800 p-2 rounded-full hover:bg-pink-600 hover:text-white transition">
                    ...
                    <a href="https://www.linkedin.com/company/security-work-capacitaciones/" class="bg-gray-800 p-2 rounded-full hover:bg-blue-700 hover:text-white transition">
            ...
            <div>
                <h4 class="text-lg font-bold text-red-500 uppercase tracking-wider mb-6">Ubicación</h4>
                
                <div class="w-full h-40 bg-gray-700 rounded-lg overflow-hidden border border-gray-600 mb-3">
                    <iframe 
                        width="100%" 
                        height="100%" 
                        frameborder="0" 
                        ...
                        marginheight="0" 
                        marginwidth="0" 
                        src="https://maps.google.com/maps?q=Paseo+Bulnes+120,+Santiago&t=&z=15&ie=UTF8&iwloc=&output=embed">
                    </iframe>
                </div>
                ...
                <div class="flex items-start text-gray-300">
                     ...
                     <p class="text-sm">Paseo Bulnes 120, Oficina 84,<br>Santiago, Región Metropolitana.</p>
                </div>
            </div>
